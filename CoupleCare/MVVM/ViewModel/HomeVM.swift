...
class HomeVM: NSObject {
    ...
    func getUserDistance(index:Int)->String{
        ...
        if (CLLocationManager.authorizationStatus() == CLAuthorizationStatus.authorizedWhenInUse ||
            ...
            return "\(calculateDistance(mobileLocationX: currentLocation.coordinate.latitude, mobileLocationY: currentLocation.coordinate.longitude, DestinationX: userLat, DestinationY: userLong)) km"
        }
        return "0 kmfd"
    }
